Project Title
FORTUNATECHECK – Plagiarism Checker System

Project Description
FORTUNATECHECK is a Python-based plagiarism detection system designed to compare two text documents and identify similarities between them.
...
Main_interface.py	Controls the whole program and menu system
cleaner.py	Preprocesses documents
searcher.py	Searches for words in both documents
checker.py	Calculates plagiarism percentage
...
Program Structure Overview
      ...
      v                     v                         v
+-------------+    +----------------+      +----------------------+
| cleaner.py   |    | searcher.py |      | checker.py|
+-------------+    +----------------+      +----------------------+
...
print("="*100)
print("WELCOME TO THE FORTUNATECHECK PLAGIARISM CHECKER")
...
This ensures:
"Python" "python" are treated as the same word.

c) Remove Punctuation
text.translate(str.maketrans('', '', string.punctuation))
Removes:
commas, periods, exclamation marks, symbols.
...
an error message is displayed, the program continues safely.
...
============================================================
WELCOME TO THE FORTUNATECHECK PLAGIARISM CHECKER
============================================================
...
Advantages of the system areit is easy to use, it has a fast comparison feature, it has organized modular structure, the system has good error handling features, reusable code and efficient word matching using sets

Limitations of the system includes it only works with text files, checks exact word similarity only, it does not detect paraphrasing, and uses basic plagiarism calculation.

Possible future improvementsincludes adding a  GUI interface(with my knowlege in HTML), making it support PDFs and DOCXs, using advanced plagiarism algorithms( through practice and indepth learning), add percentage similarity graphs (practicing graphs, store plagiarism history(using databases) and compare multiple documents simultaneously.
Conclusion

The FORTUNATECHECK Plagiarism Checker successfully demonstrates the use of Python programming concepts to build a functional plagiarism detection system.

The project effectively combines:file processing, data structures, modular programming, object-oriented programming, and error handling to produce a reliable and user-friendly application.
